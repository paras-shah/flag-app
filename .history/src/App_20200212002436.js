...
class App extends React.Component {
  ...
  componentDidUpdate(prevProps) {
    if (this.props.selectedContinentIndex && prevProps.selectedContinentIndex &&
      this.props.selectedContinentIndex !== prevProps.selectedContinentIndex) {
      return true;
    } else {
      return false;
    }
  ...
  onCountrySelect = (selectedValueIndex) => {
    // get country data
